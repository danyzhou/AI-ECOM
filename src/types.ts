...
export interface Product {
  ...
  multilingualShortDescriptions?: MultilingualText;
  multilingualLongDescriptions?: MultilingualText;
  subtitle: string;
  sku: string;
  brand?: string;
  categories: string[];
...
export type AIProviderType = 'gemini' | 'groq' | 'siliconflow' | 'openrouter' | 'custom';
...
export interface GeminiSettingConfig extends ProviderConfig {
  purpose: 'vision_analysis_and_content_generation';
}

export interface AISettingConfig {
  provider: AIProviderType;
  geminiModel?: string; // Legacy compatibility
...
export interface AITask {
  ...
  geminiVision?: GeminiVisionResult;
