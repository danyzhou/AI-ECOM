      ...
      <div className="flex items-center space-x-3">
        <div className="hidden sm:flex items-center space-x-2 px-3 py-1.5 bg-slate-950 border border-slate-800 rounded-xl text-xs">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-2 py-0.5 rounded-md bg-cyan-950/70 border border-cyan-800/60 text-cyan-300 hover:border-cyan-500 transition text-[11px]"
            title="OpenAI API: 图片优化与视觉解析"
          >
          ...
          <button
            ...
            title="Gemini API: 商品文案生成与 SEO 优化"
          >
