...
let pipelineTasksList: any[] = [
  {
    ...
    geminiVision: {
      ...
      visualHighlights: "主体识别清晰，完成多模态视觉属性建模"
    },
    wcResult: {
      wcProductId: 8841,
      wcPermalink: "https://mx-fashion-trend.com/product/smart-noise-canceling-wireless-headphones-pro"
    },
    logs: [
      "[00:00:01] [Task 1] 上传图片接收完成, 创建管道任务 task-pipe-101",
      "[00:00:03] [Task 2] Gemini Vision 启动: 识别商品类型 (头戴式降噪耳机)",
      "[00:00:06] [Task 2] 视觉算法解析: 提取商品特征与属性参数",
      "[00:00:09] [Task 3] Gemini AI 启动: 读取 Vision 数据，生成多语言标题与 SEO",
  ...
  },
  {
    ...
    progress: 50,
    elapsedSeconds: 6.8,
    message: "Gemini 图像解析完成，正在等待 Gemini 生成文案...",
    geminiVision: {
      ...
      visualHighlights: "图片解析完成，识别主要结构"
    },
    logs: [
      "[00:00:01] [Task 1] 接收图片 URL 任务注册",
      "[00:00:04] [Task 2] Gemini Vision 完成多模态特征识别",
